...
ALLOWED_HOSTS = ['infineonparking-production.up.railway.app', '127.0.0.1', 'localhost']
...
PWA_APP_NAME = 'Infineon Parking'
PWA_APP_DESCRIPTION = "Rezervisanje parking mesta"
